...
// Carte : surface pleine (ink-800) + bordure fine, plus de dégradé. Hover discret émeraude.
export const cardBaseClasses =
  'rounded-3xl border border-white/[0.06] bg-ink-800 shadow-card transition-all duration-300 ' +
